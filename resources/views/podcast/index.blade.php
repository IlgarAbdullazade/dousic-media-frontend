            ...
            <div class="podcast__container">
                <div class="podcast__wrapper">
                    ...
                    <div class="podcast__body">
                        <div class="podcast__col">
                            <div class="podcast-content">
                                <div class="podcast-content__wrapper">
                                    ...
                                    <div class="podcast-content__player podcast-player">
                        ...
                        <div class="podcast__col">
                            <div class="podcast-more">
                                <div class="podcast-more__wrapper">
                                    <h2 class="podcast-more__title">More Episode</h2>
                                    <div class="podcast-more__col">
                                        <x-common.podcast-item-v2 class="podcast-more__item" />
                                        <x-common.podcast-item-v2 class="podcast-more__item" />
                                        <x-common.podcast-item-v2 class="podcast-more__item" />
                                        <x-common.podcast-item-v2 class="podcast-more__item" />
                                        <x-common.podcast-item-v2 class="podcast-more__item" />
